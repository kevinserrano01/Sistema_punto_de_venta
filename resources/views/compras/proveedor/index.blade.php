            ...
            <div class="card">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="input-group mb-6">
                                        ...
                                        <input type="text" class="form-control" name="searchText" placeholder="Buscar proveedores" value="{{$searchText}}" aria-label="Recipient's username" aria-describedby="button-addon2">
                ...
                <div class="card-content">
                    ...
                    <div class="table-responsive">
                        ...
                        {{ $proveedores->links() }} <!-- Paginar nuestros registros de 7 en 7 -->
                    </div>
                </div>
            </div>
        </div>
